...
class App extends Component {
	constructor(props) {
		...
		this.state = {
			...
			exampleImages: [
				{
					id: "5ec14ad608db08b724a2b4e0",
					src: " ../sample_image_0.jpg",
					selected: false,
				},
				{
					id: "5ec14be608db082acaa2b4e1",
					src: " ../sample_image_1.jpg",
					selected: false,
				},
				{
					id: "5ec14c1608db080a3ca2b4e3",
		...
		return (
			<div className="App">
				<Navbar className="yellow">
					<NavbarText className="text-white mx-auto navbar-brand text-uppercase font-weight-bold">
						<h1>Color This</h1>
					</NavbarText>
				</Navbar>
				<div></div>
				...
				<Container className={"my-5"}>
					<UploadBox
						...
						exampleImages={this.state.exampleImages}
						handleExampleImageClick={this.handleExampleImageClick}
						submitUrl={this.state.submitUrl}
						changeSubmitUrl={this.changeSubmitUrl}
					/>
					<DisplayImage
				...
				/>
				<footer>
					<div className="container-fluid yellow text-center text-light p-4">
						<a
							href="https://github.com/asimsedhain"
							style={{ color: "white" }}
						>
							Copyright &copy; Ashim Sedhain{" "}
